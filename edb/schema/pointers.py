...
class Pointer(referencing.ReferencedInheritingObject,
    ...
    def derive_ref(
        ...
        **kwargs: Any,
        ...
        # type ignore below, because Pointer is a ReferencedObject
        return super().derive_ref(  # type: ignore
...
class PseudoPointer(s_abc.Pointer):
    ...
    def get_displayname(self, schema: s_schema.Schema) -> sn.Name:
        return self.get_name(schema)
    ...
    def get_path_id_name(self, schema: s_schema.Schema) -> sn.Name:
        return self.get_name(schema)
    ...
    def get_source(self, schema: s_schema.Schema) -> s_types.Type:
...
class PointerCommandOrFragment(
    ...
    def _parse_computable(
        ...
        self.set_attribute_value('cardinality', expression.irast.cardinality)
...
) -> Tuple[s_schema.Schema, so.Object]:
    from . import sources as s_sources
