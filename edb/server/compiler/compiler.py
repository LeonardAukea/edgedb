...
def compile_edgeql_script(
    ...
    units = compiler._compile(ctx=ctx, eql_tokens=tokens)
...
class Compiler(BaseCompiler):
    ...
    def _compile(
        ...
        *,
        ...
        statements = edgeql.parse_block_tokens(eql_tokens)
    ...
    async def compile_eql_tokens(
        ...
        return self._compile(ctx=ctx, eql_tokens=eql_tokens)
    ...
    async def describe_database_restore(
        ...
        units = self._compile(
            ctx=ctx,
            eql_tokens=tokenizer.tokenize(schema_ddl),
        )
